    ...
    <div className="relative group flex items-center hover:bg-black/5 p-4 transition w-full">
      <div className="group flex gap-x-2 items-center w-full">
        ...
        <div className="flex flex-col w-full">
            ...
            isPdf && (
              <div className="relative flex items-center pt-2 mt-2 rounded-md bg-background/10">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="ml-2 text-sm text-indigio-500 dark:text-indigo-400 hover:underline"
                >
                  PDF file
                </a>
              </div>
          ...
          {!fileUrl && !isEditing && (
            <p className={cn(
              "text-sm text-zinc-600 dark:text-zinc-300 darK:text-zinc-300",
            ...
            !fileUrl && isEditing && (
              <Form {...form}>
                <form
                  ...
                  className="flex items-center w-fu;; gap-x-2 pt-2"
                >
                  <FormField
